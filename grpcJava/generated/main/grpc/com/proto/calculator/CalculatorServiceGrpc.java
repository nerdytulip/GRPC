...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest,
      com.proto.calculator.ArmstrongNumberResponse> getArmstrongNumberMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ArmstrongNumber",
      requestType = com.proto.calculator.CalculatorRequest.class,
      responseType = com.proto.calculator.ArmstrongNumberResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest,
      com.proto.calculator.ArmstrongNumberResponse> getArmstrongNumberMethod() {
    io.grpc.MethodDescriptor<com.proto.calculator.CalculatorRequest, com.proto.calculator.ArmstrongNumberResponse> getArmstrongNumberMethod;
    if ((getArmstrongNumberMethod = CalculatorServiceGrpc.getArmstrongNumberMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getArmstrongNumberMethod = CalculatorServiceGrpc.getArmstrongNumberMethod) == null) {
          CalculatorServiceGrpc.getArmstrongNumberMethod = getArmstrongNumberMethod = 
              io.grpc.MethodDescriptor.<com.proto.calculator.CalculatorRequest, com.proto.calculator.ArmstrongNumberResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calculator.CalculatorService", "ArmstrongNumber"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.CalculatorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.ArmstrongNumberResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CalculatorServiceMethodDescriptorSupplier("ArmstrongNumber"))
                  .build();
          }
        }
     }
     return getArmstrongNumberMethod;
  }
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void armstrongNumber(com.proto.calculator.CalculatorRequest request,
        io.grpc.stub.StreamObserver<com.proto.calculator.ArmstrongNumberResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getArmstrongNumberMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getArmstrongNumberMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.proto.calculator.CalculatorRequest,
                com.proto.calculator.ArmstrongNumberResponse>(
                  this, METHODID_ARMSTRONG_NUMBER)))
          .addMethod(
  ...
  public static final class CalculatorServiceStub extends io.grpc.stub.AbstractStub<CalculatorServiceStub> {
    ...
    public void armstrongNumber(com.proto.calculator.CalculatorRequest request,
        io.grpc.stub.StreamObserver<com.proto.calculator.ArmstrongNumberResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getArmstrongNumberMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CalculatorServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.proto.calculator.ArmstrongNumberResponse armstrongNumber(com.proto.calculator.CalculatorRequest request) {
      return blockingUnaryCall(
          getChannel(), getArmstrongNumberMethod(), getCallOptions(), request);
    }
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractStub<CalculatorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.calculator.ArmstrongNumberResponse> armstrongNumber(
        com.proto.calculator.CalculatorRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getArmstrongNumberMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SQUARE = 0;
  private static final int METHODID_ARMSTRONG_NUMBER = 1;
  private static final int METHODID_PRIME_FACTORS = 2;
      ...
      switch (methodId) {
        case METHODID_SQUARE:
          serviceImpl.square((com.proto.calculator.CalculatorRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.calculator.CalculatorResponse>) responseObserver);
          break;
        case METHODID_ARMSTRONG_NUMBER:
          serviceImpl.armstrongNumber((com.proto.calculator.CalculatorRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.calculator.ArmstrongNumberResponse>) responseObserver);
          break;
      ...
      synchronized (CalculatorServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getArmstrongNumberMethod())
